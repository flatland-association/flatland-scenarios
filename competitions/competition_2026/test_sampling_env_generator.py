...
from competitions.competition_2026.sampling_env_generator import sampling_env_gnerator
from flatland.envs.persistence import RailEnvPersister


def test_sampling_env_generator() -> None:
    sampling_env = sampling_env_gnerator(RailEnvPersister.load_new("level_0_scenario_1.pkl", load_from_package="competitions.competition_2026.level_0")[0])
